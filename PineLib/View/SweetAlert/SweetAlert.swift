...
/*****
 ...
 let color1 = UIColor(red: 0xD0/255, green: 0xD0/255, blue: 0xD0/255, alpha: 1)
 let color2 = UIColor(red: 0xDD/255, green: 0x6B/255, blue: 0x55/255, alpha: 1)
 
 _ = SweetAlert().showAlert("Are you sure?", subTitle: "You file will permanently delete!", style: AlertStyle.warning, buttonTitle:"Cancel", buttonColor:color1 , otherButtonTitle:  "Yes, delete it!", otherButtonColor: color2) { (isOtherButton) -> Void in
...
public class SweetAlert: UIViewController {
    ...
    fileprivate func resizeAndRelayout() {
        ...
        if self.subTitleTextView.text.isEmpty == false {
            ...
            let rect = subtitleString.boundingRect(with: CGSize(width: width, height: 0.0), options: NSStringDrawingOptions.usesLineFragmentOrigin,
                                                   context: nil)//attributes: [NSFontAttributeName:subTitleTextView.font!], 
        ...
        for button in buttons {
            ...
            buttonRect.append(string.boundingRect(with: CGSize(width: width, height:0.0), options: NSStringDrawingOptions.usesLineFragmentOrigin,
                                                   context:nil))//attributes:[NSFontAttributeName:button.titleLabel!.font],
        }
